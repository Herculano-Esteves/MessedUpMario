...
changeVelocidade mapa perso     | gravidadeQuedaonoff mapa perso = perso {posicao = ((fst $ (posicao perso)) + (fst $ (velocidade perso)), (snd $ (posicao perso)) + (snd gravidade)), velocidade = (fst (velocidade perso),snd gravidade) }
