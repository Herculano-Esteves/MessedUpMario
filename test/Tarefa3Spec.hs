...
pl1 = Personagem (0.0,0.0) Jogador (8.5,7) Oeste (0.8,0.8) False False 10 0 (True, 10.0) False (False,0,0)

en1 = Personagem (0.0,0.0) Fantasma (8,7) Este (0.8,0.8) False True 10 0 (False, 0.0) False (False,0,0)
en2 = Personagem (0.0,0.0) Fantasma (8.7,7) Este (0.8,0.8) False True 10 0 (False, 0.0) False (False,0,0)
...
j4 = Jogo gameMap1 [] [] (pl2 {aplicaDano = (True, 10.0)}) 3 ((0,0),(0,0)) 0 False
...
pl3 = Personagem (0.0,0.0) Jogador (3.5,4) Oeste (0.8,0.8) True False 10 0 (False, 0.0) False (False,0,0)
...
pl5 = Personagem (0.0,0.0) Jogador (5,7.6) Oeste (1,1) False False 10 0 (False, 0.0) False (False,0,0)
en3 = Personagem (0.0,0.0) Fantasma (2.5,7.6) Este (1,1) False True 10 0 (False, 0.0) False (False,0,0)
...
pl6 = Personagem (0.0,0.0) Jogador (5,1) Oeste (1,1) False False 10 0 (False, 0.0) False (False,0,0)
c2 = (Moeda, (5,1))
