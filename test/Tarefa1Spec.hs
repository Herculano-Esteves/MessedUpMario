...
pl1 = Personagem (0.0,0.0) Jogador (8.5,6.5) Este (0.6,0.6) False False 10 0 (False, 0.0) False

teste4 = "T4: Jogador nao colide com nenhuma parede " ~: False ~=? colisoesParede gameMap1 pl1

pl2 = Personagem (0.0,0.0) Jogador (0.2,6.5) Este (1,1) False False 10 0 (False, 0.0) False

teste5 = "T5: Jogador colide com limite lateral " ~: True ~=? colisoesParede gameMap1 pl2

pl3 = Personagem (0.0,0.0) Jogador (8.5,0.2) Este (1,1) False False 10 0 (False, 0.0) False

teste6 = "T6: Jogador colide com limite superior " ~: True ~=? colisoesParede gameMap1 pl3

pl4 = Personagem (0.0,0.0) Jogador (7.5,2.5) Este (1,1) False False 10 0 (False, 0.0) False
